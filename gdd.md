...
| LP-03  | Mal uso o confusión con operadores relacionales   | `Lógica Proposicional`      | El alumno posee problemas usando <, >, <=, >=, =, !=. Comparaciones imposibles, comparadores duplicados o confusión entre = y !=.                                                                                                                                                                       |
