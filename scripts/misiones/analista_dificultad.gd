...
const DIF_SI_SINO = "EC-02" # Uso incorrecto del bloque SI-SINO
const DIF_CONDICIONALES_ANIDADOS = "EC-03" # Condicionales mal anidados
const DIF_SCOPE_VARS = "VA-01" # Confusión entre variables locales y globales
const DIF_VAR_NO_INIT = "VA-02" # Uso de variables sin inicializar
const DIF_VAR_INCONSISTENTE = "VA-03" # Uso inconsistente de variables
...
func _resetear_contadores_globales():
	contador_incidencias_acumuladas = {
		...
		DIF_SI_SINO: 0,
		DIF_CONDICIONALES_ANIDADOS: 0,
		DIF_SCOPE_VARS: 0,
		DIF_VAR_NO_INIT: 0,
		DIF_VAR_INCONSISTENTE: 0,
...
func _obtener_uuid_por_codigo(codigo: String) -> String:
	...
	match codigo:
		...
		DIF_SI_SINO: return "c3003003-0000-0000-0000-000000000002"
		DIF_CONDICIONALES_ANIDADOS: return "c3003003-0000-0000-0000-000000000003"
		DIF_SCOPE_VARS: return "d4004004-0000-0000-0000-000000000001"
		DIF_VAR_NO_INIT: return "d4004004-0000-0000-0000-000000000002"
		DIF_VAR_INCONSISTENTE: return "d4004004-0000-0000-0000-000000000003"
